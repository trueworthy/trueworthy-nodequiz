    ...
    QuizComponent.prototype.onSubmit = function (form) {
        ...
        for (var x = 0; x < selectedisCorrectProp.length; x++) {
            ...
            for (var i = 0; i < selectedAnswerIds.length; i++) {
                for (var x_1 = 0; x_1 < selectedisCorrectProp.length; x_1++) {
                    if (selectedAnswerIds[i] === selectedisCorrectProp[x_1]) {
                        correctRunningTotal += 1;
                        console.log('selectedAnswers: ' + selectedAnswerIds[i] + ' correctAnswers: ' + selectedisCorrectProp[x_1] + ' correctRunningTotal: ' + correctRunningTotal);
                    }
                }
            }
            ...
            /* this.cumulativeSummary = {
             ...
             this.http.post('/api/summary/', {
               ...
               console.log(err);
                ...
                var dialogRef = this.dialog.open(_results_results_component__WEBPACK_IMPORTED_MODULE_8__["ResultsComponent"], {
                    data: {
...
var ResultsComponent = /** @class */ (function () {
    function ResultsComponent(dialogRef, data, router, cookieService) {
    ...
    ResultsComponent.prototype.summary = function () {
