...
var CumulativeSummaryComponent = /** @class */ (function () {
    function CumulativeSummaryComponent(http) {
        ...
        this.http.get('/api/cumulative-summary').subscribe(function (res) {
            _this.cumulativeSummary = res;
        });
    }
...
var QuizComponent = /** @class */ (function () {
    ...
    QuizComponent.prototype.onSubmit = function (form) {
        ...
        var pointsPerQuestions = totalPossiblePoints / questionCount;
        var quizScore = 0;
        ...
        this.http.post('/api/result/', {
            ...
            try {
                 ...
                 */
                for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](_this.quiz.questions), _d = _c.next(); !_d.done; _d = _c.next()) {
             ...
             */
            _this.quizSummary['quizId'] = _this.quizId;
            _this.quizSummary['quizName'] = _this.quiz.name;
            _this.quizSummary['score'] = quizScore;
            _this.quizSummary['correctAnswers'] = correctAnswers;
            _this.quizSummary['selectedAnswers'] = selectedAnswers;
            /**
             * 6. Create the cumulative summary object and insert into the database
             */
            _this.cumulativeSummary = {
                employeeId: _this.employeeId,
                quizId: _this.quizId,
                quizName: _this.quiz.name,
                dateTaken: moment__WEBPACK_IMPORTED_MODULE_8__().format('MM/DD/YYYY'),
                score: (correctRunningTotal * pointsPerQuestions)
            };
            _this.http.post('/api/summary/', {
                employeeId: _this.cumulativeSummary['employeeId'],
                quizId: _this.cumulativeSummary['quizId'],
                ...
                dialogRef.afterClosed().subscribe(function (quizResults) {
...
var ResultsComponent = /** @class */ (function () {
    function ResultsComponent(dialogRef, data, cookieService) {
...
module.exports = __webpack_require__(/*! /Users/leatrueworthy/bu-webdev/trueworthy-nodequiz/src/main.ts */"./src/main.ts");
